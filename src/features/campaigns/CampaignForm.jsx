  ...
  return (
    <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300">
      ...
      {errors.recipientStats && (
        <p className="text-red-400 text-sm font-bold bg-red-900/20 p-2 rounded">
      ...
      <div className="flex flex-wrap items-center gap-4">
        ...
        <span className="text-xs text-slate-500">
          Supported formats: .txt, .csv (one email per line)
        </span>
      </div>
    </div>
  );
    ...
    <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300">
      ...
      <div className="mb-4">
        <button
          ...
          className="flex items-center justify-between w-full p-3 sm:p-4 bg-slate-800 hover:bg-slate-700 text-slate-200 rounded border border-slate-700 transition-colors text-sm sm:text-base"
        >
        ...
        {showSettings && (
          <div className="mt-2 p-3 sm:p-4 bg-slate-900/50 border border-slate-700 rounded space-y-4">
            {/* First Row */}
                ...
                <div className="flex gap-3 sm:gap-4 mt-2">
                  <label className="flex items-center gap-1 sm:gap-2 cursor-pointer">
                    <input
                      ...
                      value="yes"
                      className="accent-blue-500 w-3 h-3 sm:w-4 sm:h-4"
                    />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
              ...
              <div className="flex items-end">
                <div className="flex gap-2 w-full">
                  <button
                    type="button"
                    className="flex-1 px-3 py-2 bg-green-600 hover:bg-green-700 text-white rounded transition-colors text-xs sm:text-sm"
                  >
                    Start
                  </button>
                  <button
                    type="button"
                    className="flex-1 px-3 py-2 bg-red-600 hover:bg-red-700 text-white rounded transition-colors text-xs sm:text-sm"
                  >
                    Stop
                  </button>
                </div>
      ...
      <div className="mb-6 p-3 sm:p-4 bg-slate-900/50 border border-slate-700 rounded">
        <h3 className="text-sm sm:text-md font-semibold text-white mb-3">
          Additional Header
        </h3>
        ...
        <div className="mb-4">
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            ...
            <div className="flex gap-1 sm:flex-nowrap">
              <label className="flex items-center gap-1 px-2 sm:px-3 py-2 bg-slate-800 border border-slate-700 rounded cursor-pointer">
                <input
                  type="radio"
              ...
              <label className="flex items-center gap-1 px-2 sm:px-3 py-2 bg-slate-800 border border-slate-700 rounded cursor-pointer">
                <input
                  ...
                  defaultChecked
                />
                <span className="text-xs sm:text-sm text-slate-300">RESET</span>
              </label>
            </div>
          </div>
        </div>
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-wrap bg-slate-800 rounded p-1 w-fit max-w-full">
      ...
      <div className="mb-6">
        <div className="flex flex-wrap gap-2">
          <button
            type="button"
            className="flex items-center gap-1 sm:gap-2 px-2 sm:px-4 py-1 sm:py-2 bg-slate-800 hover:bg-slate-700 text-slate-200 rounded transition-colors border border-slate-600 text-xs sm:text-sm"
          >
      ...
      <div className="pt-2">
        ...
        {showAdvanced && (
          <div className="mt-4 p-3 sm:p-4 bg-slate-900/50 border border-slate-700 rounded space-y-4">
            <div>
              <label className="block text-sm font-medium text-slate-400 mb-1">
                Character Encoding
              </label>
      ...
      <div className="flex gap-4 p-4 bg-blue-900/20 border border-blue-900/50 rounded-lg">
        ...
        <div>
          ...
          <p className="text-blue-400/80 text-sm">
            Review all settings above. Once you click "Launch Campaign", the
            process will start immediately or at the scheduled time.
          </p>
        </div>
      </div>
    </div>
...
const steps = [
  { number: 1, title: "Campaign Setup", fields: ["name"] },
  {
    number: 2,
    title: "Recipients",
    fields: ["recipientStats", "recipientsText"],
  },
  {
    number: 3,
    title: "Sender Details",
    fields: ["fromEmail", "subject", "replyTo"],
  },
