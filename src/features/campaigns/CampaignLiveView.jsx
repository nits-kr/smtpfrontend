    ...
    <div className="min-h-screen bg-black text-green-500 font-mono p-4 overflow-hidden flex flex-col">
      ...
      <div className="flex flex-col mb-2">
        <div className="flex items-center justify-between mb-2">
          ...
          <h1 className="text-xl md:text-2xl font-bold tracking-wider text-green-600">
            {id || "Unknown Campaign"}
          </h1>
          <div className="w-100">
            <CampaignState id={id} />
      ...
      <div className="flex-1 overflow-y-auto bg-black p-2 font-mono text-xs md:text-sm leading-relaxed scrollbar-hide">
        <div className="text-green-600 space-y-1">
          <div>
            Checking Inbox Status and Matching Percentage ..! GIVEN : 100%
          </div>
        ...
        <div className="mt-2 space-y-1">
          {logs.map((log, index) => (
            <div
              key={index}
              className="whitespace-nowrap break-all hover:bg-white/5"
            >
              <span className="text-green-500 font-semibold">
                Total Mail Sent : {log.snapshotStats.sent}
              </span>
              <span className="mx-1 text-green-700">||</span>
              <span className="text-green-500 font-semibold">
                Total Mail Recieved : {log.snapshotStats.received}
              </span>
              <span className="mx-1 text-green-700">||</span>
              <span className="text-green-500 font-semibold">
                INBOX : {log.snapshotStats.inbox}
              </span>
              <span className="mx-1 text-green-700">||</span>
              <span className="text-green-500 font-semibold">
                SPAM : {log.snapshotStats.spam}
              </span>
              <span className="mx-1 text-green-700">||</span>
              ...
              <span
                className={
                  log.status === "completed" ? "text-green-500" : "text-red-500"
                }
              >
              ...
              <span className="text-green-600">
                sidharthsidh025@yahoo.com 3
              </span>
              <span className="mx-1 text-green-700">||</span>
              <span className="text-green-500">
                Inbox Percentage : {log.status === "completed" ? "33.333" : "0"}
                %
              </span>
            </div>
          ))}
